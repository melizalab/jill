...
need to compile a test hdf5 library so I can run valgrind
...
** TODO run jack_interposer
*** DONE jstim
*** DONE jdetect

failed the test because std::deque allocates memory. switched to a boost::circular_buffer.
