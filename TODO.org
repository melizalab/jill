...
* TODO [#A] jstim: handle invalid stimulus files
* TODO [#A] jrecord won't trigger off jdetect
* TODO [#B] jrecord: more flexible specification of input ports
...
doesn't exist, to just create a port with that name.
