...
should anticipate non-jack data sources; might make it easier to test. However,
there is a lot of jack-specific code elsewhere that would need to be tracked down.
