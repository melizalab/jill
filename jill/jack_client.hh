 ...
 *
 * It provides a std::function based interface for many of the callbacks,
...
public:
         ...
         */
        using ProcessCallback = std::function<int (jack_client *, nframes_t, nframes_t)>;
         ...
         */
        using PortRegisterCallback = std::function<void (jack_client *, jack_port_t *, int)>;
         ...
         */
        using PortConnectCallback = std::function<void (jack_client *, jack_port_t *, jack_port_t *, int)>;

        using SamplingRateCallback = std::function<int (jack_client *, nframes_t)>;
