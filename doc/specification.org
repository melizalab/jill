...
*** TODO update arf c++ interface to support table types

Doing this with template metaprogramming may be a huge bear. I should probably
just write some specific methods.

*** DONE Decide how to store event data                             :noexport:
...
like jcapture. Can also be used for presentation of stimuli while searching for
neurons.
